...
namespace QueryHardwareSecurity {
    internal static class Utilities {
        ...
        /// <summary>
        ///     Retrieves the data under the specified key for the provided ExpandoObject. If the key does not exist, it is
        ///     created and its value set to an empty ExpandoObject.
        /// </summary>
        ...
        /// <summary>Loads the embedded resource with the specified name as a JSON object.</summary>
        ...
        /// <summary>
        ///     Checks if the platform is supported. If the platform is unsupported, immediately exits with a non-zero exit
        ///     code.
        /// </summary>
        ...
        /// <summary>Retrieves a CIM instance with the provided instance ID.</summary>
        ...
        /// <summary>Writes a debug message to the console.</summary>
        ...
        /// <summary>Writes a verbose message to the console.</summary>
